...
const FruitJar: React.FC<FruitJarProps> = ({
  ...
  return (
    <div className="flex flex-col items-center bg-[url(/src/assets/glass-jar.png)] bg-contain bg-center bg-no-repeat relative w-full h-[60vh] lg:h-[90vh] lg:w-[415px] 2xl:w-full">
      {/*Absolute positioned clear jar button*/}
      <Tooltip>
      ...
      <Tabs
        ...
        className="relative top-[30%] left-0 w-[50%] h-full max-h-[65%] md:max-h-[65%] min-w-[350px] 2xl:min-w-[400px] 2xl:w-[60%] 2xl:top-[25%]"
      >
        ...
        <TabsContent value="contents" className="h-full">
          <div className="flex flex-col w-full h-full bg-white border p-4 rounded-lg shadow-lg max-h-[400px] 2xl:max-h-[600px] 2xl:p-8 2xl:pr-12 2xl:pl-12">
